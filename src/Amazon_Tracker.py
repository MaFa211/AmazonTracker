...
# Get Request
    def get_request(self, url, str_user_agent, proxy):
        s = HTMLSession()
        fake_agent = user_agent()
        fake_agent = {'user_agent': str_user_agent}
...
class RequestData:
    ...
    agent_url = "https://user-agents.net/random"
    ...
    def get_user_agent_list():
        s = HTMLSession()
        request = s.get(RequestData.agent_url)
        parsed_request = BeautifulSoup(request.content, "html.parser")
